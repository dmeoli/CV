...
\name{Donato}{Meoli}
\position{Computer Scientist{\enskip\cdotp\enskip}MSc Student in Computer Science with major in Artificial Intelligence}
% \address{Via Lama di Cervo, 130 \\ 70022 Altamura, Bari, Italy}

\mobile{(+39) 389 157 2680}
\email{donato.meoli@outlook.com}
% \homepage{www.posquit0.com}
\github{dmeoli}
\linkedin{donato-meoli}
% \gitlab{gitlab-id}
...
% \quote{``Dignity does not consist in possessing honors, but in deserving them." \textsc{ Aristotele}}
